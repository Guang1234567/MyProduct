...
public abstract class TodoList extends BaseEntity implements Parcelable {
    ...
    public static Function<Cursor, TodoList> mapper() {
    ...
    public abstract static class Builder {
        ...
        public abstract TodoList build();
    }

    public static Builder builder() {
        return new AutoValue_TodoList.Builder().rowId(-1L).rowCount(0L);
    }

    public Builder newBuilder() {
        return new AutoValue_TodoList.Builder()
                .rowId(rowId())
                .rowCount(rowCount())
                .name(name())
                .archived(archived());
