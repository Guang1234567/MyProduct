 ...
 * <p>
 * Copy from com.google.common.base.Preconditions
 */
public final class Preconditions {
    ...
    public static <T extends CharSequence> T checkNotEmpty(T string) {
    ...
    public static <T extends CharSequence> T checkNotEmpty(T string, @Nullable Object errorMessage) {
        if (TextUtils.isEmpty(string)) {
            throw new IllegalArgumentException(String.valueOf(errorMessage));
        } else {
            return string;
    ...
    public static <T extends CharSequence> T checkNotEmpty(T string, @Nullable String errorMessageTemplate, @Nullable Object... errorMessageArgs) {
        if (TextUtils.isEmpty(string)) {
            throw new IllegalArgumentException(format(errorMessageTemplate, errorMessageArgs));
        } else {
            return string;
    ...
    public static <T extends Collection<Y>, Y> T checkNotEmpty(T collection, @Nullable Object errorMessage) {
        if (collection.isEmpty()) {
            throw new IllegalArgumentException(String.valueOf(errorMessage));
        }
        return collection;
    ...
    public static <T extends Collection<Y>, Y> T checkNotEmpty(T collection, @Nullable String errorMessageTemplate, @Nullable Object... errorMessageArgs) {
        if (collection.isEmpty()) {
            throw new IllegalArgumentException(format(errorMessageTemplate, errorMessageArgs));
        }
        return collection;
